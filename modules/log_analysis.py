...
def discover_logs():
    """
    Discover ONLY genuine security/log files.
    Never recursively scan the entire Android/Termux/Kali filesystem.
    """
    ...
    candidates = [
        ...
        os.path.expanduser("~/.termux/termux.log"),
        os.path.expanduser("~/.termux/boot.log"),
    ]
    ...
    # Only explicitly named user log directories.
    safe_dirs = [
        Path.home() / "logs",
        Path.home() / "security-logs",
        Path.home() / "sentinelsoc-logs",
        Path("/storage/emulated/0/Logs"),
        Path("/storage/emulated/0/SecurityLogs"),
    ]
        ...
        try:
            ...
            for path in directory.iterdir():
                ...
                if (
                    ...
                    or path.suffix.lower() in allowed_ext
                ):
                    try:
